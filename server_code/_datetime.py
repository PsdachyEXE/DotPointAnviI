...
NOTE: _urgency_band(days_remaining) is specified for this module but depends on
_constants.URGENCY_THRESHOLDS; it is added in the Assessments slice (§10 step 2)
alongside _constants, which is its first consumer.
"""
